...
def prepare_training_data():
    ...
    for i in range(nums):
        ...
        for j in range(Random_Crop):
            ...
            lr_patch = cv2.resize(hr_patch, (int(label_size / scale), int(label_size / scale)), cv2.INTER_CUBIC)
...
if __name__ == "__main__":
    ...
    write_hdf5(data, label, "Nov_test/oneval2x.h5")
